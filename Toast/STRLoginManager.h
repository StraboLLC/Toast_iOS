 ...
 */
@protocol STRLoginManagerDelegate
 ...
 */
@interface STRLoginManager : NSObject {
    id delegate;
...
/**
 Finds and returns the [STRAppDelegate loginManager] pointer owned by the app delegate (which should be a [STRAppDelegate].
 
 @return The default STRLoginManger in the [STRAppDelegate]
 */
